...
# Sample dish_data (Ensure this is structured correctly)
dish_data = [
    (1, "Pasta Alfredo", "images/pasta_alfredo.jpg", "500;60g;20g;15g", "Pasta, Cream, Cheese, Garlic", "Boil pasta, prepare sauce, mix & serve"),
    ('02', 'Microwave Poached Eggs', 'images/dishes/02.jpg', '72;0;5;6',
         'Egg:1 fruit;Vinegar: 1/8 teaspoon;Water: 1/3 cup', 'Add the water and white vinegar...'),
        ('03', 'Tuna and Hummus', 'images/dishes/03.jpg', '86.5;2.5;2;15',
         'Tuna: 2.5 oz;Rosemary: 1/2 teaspoon;Pepper: 0.1 g;Hummus: 1 tablespoon',
         'Mix all ingredients together and serve.'),
        (
        '04', 'Carrots', 'images/dishes/04.jpg', '86;20;0;2', 'Baby carrots: 246 g',
        'Enjoy by themselves. Optionally, enjoy with a side of hummus (there are other carrot + dip recipes on ETM you can swap in).'),
        ('05', '6 Minute Salmon', 'images/dishes/05.jpg', '257;7;10;37',
        ...
        ('06', 'Green Kale Salad', 'images/dishes/06.jpg', '72;10;2;4',
        ...
        ('07', 'Cream Cheese Omelet', 'images/dishes/07.jpg', '295;1;27;12',
        ...
        ('08', 'Strawberries','images/dishes/08.jpg', '46;11;0;1',
         'Strawberries: 144 g', 'Wash and eat.'),
        ('09', 'Cottage Cheese and Black Bean Tuna Salad','images/dishes/09.jpg',
        ...
        ('10', 'Spinach Tomato Salad','images/dishes/10.jpg', '186;13;14;6',
        ...
        ('11', 'Pasta with Red Sauce and Mozzarella','images/dishes/11.jpg',
        ...
        ('12', 'Blackberry Chocolate Shake','images/dishes/12.jpg', '214;17;17;2',
        ...
        ('13', 'Oranges', 'images/dishes/13.jpg', '62;15;0;1', 'Oranges: 1 fruit',
         'Peel or slice orange and eat.'),
        (
        '14', 'Curried Cabbage and Carrot Slaw','images/dishes/14.jpg', '61;9;0;6',
        ...
        ('15', 'Fresh Jicama Salad','images/dishes/15.jpg', '76;18;0;2',
        ...
        ('18', 'Sun-Dried Tomato Turkey Roll-up','images/dishes/18.jpg',
         '330;36;15;15',
        ...
        ('19', 'Roasted Salmon','images/dishes/19.jpg', '242;0;14;28',
        ...
        ('20', 'Veggie Omelet', 'images/dishes/20.jpg', '149;11;1;24',
        ...
        ('21', 'Tuna Poke','images/dishes/21.jpg', '164;1;4;29',
        ...
        ('22', 'Green salad', 'images/dishes/22.jpg', '70;1;7;1',
        ...
        ('23', 'Thai Pork Salad','images/dishes/23.jpg', '399;9;24;35',
        ...
        ('24', 'Orange Breakfast Fruit Smoothie','images/dishes/24.jpg',
         '371;59;2;34',
         'Strawberries: 150 g;Banana: 1 fruit;Oranges: 1 fruit;Whey protein powder: 30 g;Nonfat greek yogurt: 4 tablespoon',
         'Combine all ingredients in a blender and pulse until smooth. Enjoy!'),
        ('25', 'Tomato and Cheese Wrap','images/dishes/25.jpg', '302;29;16;11',
        ...
        ('26', 'Yogurt with Papaya','images/dishes/26.jpg', '194;23;1;24',
         'Nonfat greek yogurt: 8 oz;Papayas: 140 g', 'Peel and seed papaya and slice. Mix into yogurt and enjoy!'),
        ('27', 'Vietnamese Tofu and Noodle Salad','images/dishes/27.jpg',
         '321;29;19;12',
        ...
        ('30', 'Turkey Wrap','images/dishes/30.jpg', '391;29;22;20',
        ...
        ('31', 'Shrimp Cakes','images/dishes/31.jpg', '110;5;4;12',
        ...
        ('32', 'Tuna Apple Salad','images/dishes/32.jpg', '482;29;13;65',
        ...
        ('33', 'Basic Parmesan Egg White Omelet','images/dishes/33.jpg',
         '228;4;15;18',
        ...
        ('34', 'Turkey, Goat Cheese, and Avocado Roll','images/dishes/34.jpg',
         '120;4;9;6',
        ...
        ('35', 'Chicken Soup', 'images/dishes/35.jpg', '318;22;10;33',
        ...
        ('36', 'Salsa salad','images/dishes/36.jpg', '187;37;2;10',
        ...
        ('37', 'Easy Steamed Green Beans', 'images/dishes/37.jpg', '31;7;0;2',
        ...
        (
            '38', 'Peanut Butter Banana Oatmeal', 'images/dishes/38.jpg',
            '309;47;11;11',
        ...
        ('39', 'Tuna Avocado Salad', 'images/dishes/39.jpg', '124;4;6;15',
        ...
        (
            '40', 'Spicy Yogurt Dip with Carrots', 'images/dishes/40.jpg',
            '120;16;1;13',
        ...
        ('41', 'Simple Steak', 'images/dishes/41.jpg', '293;0;15;38',
        ...
        ('42', 'Mediterranean Salad','images/dishes/42.jpg', '74;18;0;2',
        ...
        ('43', 'Cottage Cheese & Applesauce','images/dishes/43.jpg', '214;20;2;28',
         'Applesauce: 120 g;Cottage cheese: 225 g', 'Mix together and enjoy!'),
        ('44', 'Turkey Salad', 'images/dishes/44.jpg', '276;4;9;42',
        ...
        ('45', 'Cinnamon Yogurt with Sliced Apple','images/dishes/45.jpg',
        ...
        ('46', 'Greek Spaghetti','images/dishes/46.jpg', '687;86;27;25',
        ...
        ('47', 'Spinach and Poached Egg Muffins', 'images/dishes/47.jpg',
         '375;38;15;25',
        ...
        ('48', 'Whole Wheat Toast','images/dishes/48.jpg', '71;12;1;3',
         'Whole-wheat bread: 1 slices',
         'Put a slice of whole wheat bread into the toaster. Eat by itself or as a side.'),
        ('49', 'Cucumber Apple Salad','images/dishes/49.jpg', '98;24;1;2',
        ...
        ('50', 'Broccoli Potato Soup','images/dishes/50.jpg', '184;34;4;7',
        ...
        ('51', 'Cinnamon Toast','images/dishes/51.jpg', '130;19;5;4',
        ...
        (
        '52', 'Yogurt with Almonds & Honey','images/dishes/52.jpg', '259;18;10;27',
        'Nonfat greek yogurt: 8 oz;Almonds: 18 g;Honey: 1 teaspoon',
        'Rough-chop almonds and mix into yogurt and honey. Enjoy!'),
        ('53', 'Stuffed Sweet Potato with Hummus','images/dishes/53.jpg',
        ...
        ('54', 'Mango Smoothie','images/dishes/54.jpg', '170;40;1;3',
         'Mangos: 1 fruit;Coconut water: 240 g;Ice cubes: 1 piece',
         'Combine all ingredients in a blender and pulse until smooth. Enjoy!'),
        ('55', 'Yogurt & Cantaloupe','images/dishes/55.jpg', '188;21;1;24',
         'Nonfat greek yogurt: 8 oz;Melons: 160 g', 'Cut cantaloupe into pieces and mix with yogurt. Enjoy!'),
        ('56', 'Monte Cristo sandwich','images/dishes/56.jpg', '551;30;31;36',
        ...
        ('57', 'Nonfat greek yogurt','images/dishes/57.jpg', '142;9;1;24',
        ...
        ('58', 'Broccoli and Apple Salad','images/dishes/58.jpg', '55;9;2;1',
        ...
        ('62', 'Strawberry Mango Shake','images/dishes/62.jpg', '152;24;4;7',
        ...
        ('63', 'Yogurt Artichoke Dip with Rye Crisps', 'images/dishes/63.jpg',
         '169;26;1;15',
        ...
        ('64', 'Mini Flatbread Pizza','images/dishes/64.jpg', '158;22;5;9',
        ...
        ('65', 'Tofu Salad','images/dishes/65.jpg', '207;10;16;8',
        ...
        ('66', 'Banana and Kale Smoothie','images/dishes/66.jpg', '278;54;6;9',
         'Coconut water: 240 g;Banana: 75 g;Kale: 67 g;Chia seeds: 14 g;Blueberries: 111 g',
         'Combine all ingredients in a blender and pulse until smooth. Enjoy!'),
        ('67', 'Rice Cake with Strawberries and Honey','images/dishes/67.jpg',
        ...
        ('68', 'Bologna Caesar Wraps', 'images/dishes/68.jpg', '224;31;8;7',
        ...
        ('69', 'Ham, Egg Beaters, and Mushroom Scramble','images/dishes/69.jpg',
         '136;4;3;22',
        ...
        ('70', 'Salad with Ginger-Sesame-Miso Dressing','images/dishes/70.jpg',
         '23;1;2;0',
        ...
        ('71', 'Sweet Potato Hash','images/dishes/71.jpg', '304;32;15;11',
        ...
        ('72', 'Cod Stir-Fry','images/dishes/72.jpg', '303;15;7;45',
        ...
        ('73', 'Parmesan and Mushroom Baked Eggs','images/dishes/73.jpg',
         '244;4;18;16',
        ...
        ('74', 'Papaya Flaxseed Shake','images/dishes/74.jpg', '124;16;5;6',
         'Water: 3 tablespoon;Flaxseed: 1 tablespoon;Papayas: 70 g;Plain yogurt: 6 tablespoon',
         'Combine all ingredients in a blender and pulse until smooth. Enjoy!'),
        ('75', 'Cottage Cheese Tuna Salad','images/dishes/75.jpg', '322;9;5;61',
        ...
        (
        '76', 'Yogurt with Walnuts & Honey','images/dishes/76.jpg', '260;16;10;28',
        'Walnuts: 15 g;Nonfat greek yogurt: 240 g;Honey: 1 teaspoon',
        'Rough-chop walnuts and mix into yogurt;Top with honey and enjoy!'),
        ('77', 'Cheat n Eat Vietnamese Chicken Soup','images/dishes/77.jpg',
         '148;8;5;15',
        ...
        ('78', 'Zucchini Hash','images/dishes/78.jpg', '218;13;11;17',
        ...
        ('79', 'Bean Sprouts with Tofu','images/dishes/79.jpg', '140;7;9;9',
        ...
        (
        '80', 'Avocado','images/dishes/80.jpg', '322;17;29;4', 'Avocados: 1 fruit',
        'Cut in half and remove the pit;Optional topping ideas: Sea salt, black pepper, balsamic vinegar, lemon/lime juice, or paprika.'),
        ('81', 'Spinach and Mushroom Breakfast Scramble', 'images/dishes/81.jpg',
        ...
        (
            '82', 'Salami Cream Cheese Sandwich', 'images/dishes/82.jpg',
            '553;32;36;25',
        ...
        ('83', 'Ham and Avocado Egg Wrap','images/dishes/83.jpg', '231;6;18;12',
        ...
        ('87', 'Black Bean and Bacon Soup','images/dishes/87.jpg', '148;24;2;8',
        ...
        ('88', 'Basic Vegetable Juice', 'images/dishes/88.jpg', '390;92;2;12',
        ...
        ('89', 'Brie cheese on bread','images/dishes/89.jpg', '204;18;10;11',
         'Multi-grain bread: 1 slices;Brie cheese: 1 oz', 'Spread cheese on bread, eat.'),
        ('90', 'Post-Workout Banana Protein Smoothie','images/dishes/90.jpg',
         '225;30;1;25', 'Water: 470 g;Banana: 1 fruit;Whey protein powder: 30 g',
         'Combine all ingredients in a blender and pulse until smooth. Enjoy!'),
        ('91', 'Hummus Chickpea Snack Sandwiches', 'images/dishes/91.jpg',
         '142;21;4;7',
        ...
        ('93', 'Raspberry Coconut Smoothie', 'images/dishes/93.jpg', '531;88;22;5',
         'Raspberries: 250 g;Banana: 1/2 fruit;Coconut milk: 80 g;Chia seeds: 1/2 tablespoon',
         'Blend all ingredients until smooth.'),
        ('94', 'Strawberry Pear Juice','images/dishes/94.jpg', '129;34;1;1',
...
csv_file_path = 'dish_data.csv'

# Define the CSV header
header = ['ID', 'Dish Name', 'Image Path', 'Nutrition (Calories;Carbs;Fat;Protein)', 'Ingredients', 'Instructions']
...
with open(csv_file_path, 'w', newline='', encoding='utf-8') as file:
    ...
    # Writing the dish data
    writer.writerows(dish_data)

print(f"CSV file saved successfully as {csv_file_path}")
